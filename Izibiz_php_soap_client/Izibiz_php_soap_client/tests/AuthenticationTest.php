...
$params = array(
  ...
  $GLOBALS['client'] = new SoapClient('https://efaturatest.izibiz.com.tr/AuthenticationWS?wsdl',array('trace' => 1,'exceptions' => 1));
   ...
   $GLOBALS['sessionIdD']=$GLOBALS['sessionId'];
